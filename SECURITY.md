...
Replace this section with the supported versions for `prooftrace`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `prooftrace` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in prooftrace.
